...
async def info(message: types.Message):
    await message.bot.send_message(message.from_user.id, '<b>Строка информации:</b>\n\n'
                                                        'Для внесения сведений о доходе: /e, /earned, !e, !earned.\n\nПример /earned 9999\n\n'
                                                        'Для внесения сведений о расходе: /s, /spent, !s, !spent.\n\nПример /spent 9999\n\n'
                                                        'Для получения истории: /h, /history, !h, !history\n\n'
                                                        'Пример: /history, /history day(история за день), /history month(история за месяц)')    